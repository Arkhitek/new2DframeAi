...
- 下弦材: 下弦の節点を順に接続（水平材）
- 上弦材: 上弦の節点を順に接続（水平材）
- 垂直材: 各パネルの左側に配置（下弦から上弦へ垂直）
- 斜材: 各パネルの右側に下向き配置（上弦の節点から右下の下弦の節点へ）
...
- 垂直材: 2→7, 3→8, 4→9
- 斜材: 6→2, 7→3, 8→4, 9→5, 1→6, 5→10（端部）`;
            
        } else if (trussType === 'howe') {
            prompt += `**ハウトラス（Howe Truss）**の特徴:
1. 垂直材と斜材を組み合わせて使用（プラットトラスの逆）
...
- 下弦材: 下弦の節点を順に接続（水平材）
- 上弦材: 上弦の節点を順に接続（水平材）
- 垂直材: 各パネルの右側に配置（下弦から上弦へ垂直）
- 斜材: 各パネルの左側に下向き配置（上弦の節点から左下の下弦の節点へ）
...
- 上弦材: 6→7, 7→8, 8→9, 9→10
- 垂直材: 1→6, 2→7, 3→8
- 斜材: 7→2, 8→3, 9→4, 10→5, 4→9, 5→10（端部）`;
...
主な形式:
- **ワーレントラス**: 垂直材なし、斜材のみで「W」字形状
- **プラットトラス**: 垂直材あり、斜材は中央向きに下向き（∧形状）
- **ハウトラス**: 垂直材あり、斜材は外側向きに下向き（V字形状）
- **K型トラス**: 中間節点あり、各パネルに「K」字形状の斜材

節点配置の基本:
- 下弦材（y=0）: スパンを等分割
- 上弦材（y=${height}）: トラス形式に応じて配置
