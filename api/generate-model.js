...
**トラス構造の例（スパン15m、高さ3m）:**
{
  ...
  "members": [
    ...
    {"i": 4, "j": 6, "E": 205000, "I": 0.00002, "A": 0.002, "Z": 0.0002, "i_conn": "pinned", "j_conn": "pinned"},
    {"i": 6, "j": 2, "E": 205000, "I": 0.00002, "A": 0.002, "Z": 0.0002, "i_conn": "pinned", "j_conn": "pinned"},
    // 斜材（6本）
...
**トラス構造の境界条件設定ルール:**
- 支点（地面に接する節点）: 左端はピン支点（"p"）、右端はローラー支点（"r"）
- 中間節点: 全て自由（"f"）
- トラス構造では支点の配置が重要で、適切な境界条件を設定してください

**トラス構造の部材配置ルール:**
- 上弦材: 上部節点間を接続（Y座標=高さの節点間）
- 下弦材: 下部節点間を接続（Y座標=0の節点間）
- 斜材: 上弦材と下弦材の節点を対角に接続
- ワーレントラス: 斜材は交互に配置（ジグザグパターン）
- 部材数の確認: 上弦材 + 下弦材 + 斜材 = 総部材数
- 下弦材は必ず全ての下部節点間を接続してください（欠落させない）`;
...
**大規模ラーメン構造の例（5層4スパン）:**
節点配置: 各層に5本の柱（4スパン+1）、5層 = 25節点
部材配置: 20本の柱 + 20本の梁 = 40部材

{
  "nodes": [
    {"x": 0, "y": 0, "s": "x"}, {"x": 6, "y": 0, "s": "x"}, {"x": 12, "y": 0, "s": "x"}, {"x": 18, "y": 0, "s": "x"}, {"x": 24, "y": 0, "s": "x"},
    {"x": 0, "y": 3.5, "s": "f"}, {"x": 6, "y": 3.5, "s": "f"}, {"x": 12, "y": 3.5, "s": "f"}, {"x": 18, "y": 3.5, "s": "f"}, {"x": 24, "y": 3.5, "s": "f"},
    {"x": 0, "y": 7, "s": "f"}, {"x": 6, "y": 7, "s": "f"}, {"x": 12, "y": 7, "s": "f"}, {"x": 18, "y": 7, "s": "f"}, {"x": 24, "y": 7, "s": "f"},
    {"x": 0, "y": 10.5, "s": "f"}, {"x": 6, "y": 10.5, "s": "f"}, {"x": 12, "y": 10.5, "s": "f"}, {"x": 18, "y": 10.5, "s": "f"}, {"x": 24, "y": 10.5, "s": "f"},
    {"x": 0, "y": 14, "s": "f"}, {"x": 6, "y": 14, "s": "f"}, {"x": 12, "y": 14, "s": "f"}, {"x": 18, "y": 14, "s": "f"}, {"x": 24, "y": 14, "s": "f"}
  ],
  "members": [
    // 1層目の柱（5本）
    {"i": 1, "j": 6, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 2, "j": 7, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 3, "j": 8, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 4, "j": 9, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 5, "j": 10, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    // 2層目の柱（5本）
    {"i": 6, "j": 11, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 7, "j": 12, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 8, "j": 13, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 9, "j": 14, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 10, "j": 15, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    // 3層目の柱（5本）
    {"i": 11, "j": 16, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 12, "j": 17, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 13, "j": 18, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 14, "j": 19, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 15, "j": 20, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    // 4層目の柱（5本）
    {"i": 16, "j": 21, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 17, "j": 22, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 18, "j": 23, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 19, "j": 24, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 20, "j": 25, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    // 1層目の梁（4本）
    ...
    {"i": 12, "j": 13, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    ...
    {"i": 18, "j": 19, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 19, "j": 20, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    // 4層目の梁（4本）
    {"i": 21, "j": 22, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 22, "j": 23, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 23, "j": 24, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638},
    {"i": 24, "j": 25, "E": 205000, "I": 0.00011, "A": 0.005245, "Z": 0.000638}
  ]
}

**5層構造の特別注意事項:**
- 5層構造では5層目の節点（最上層）も必ず配置してください
- 5層目の柱は4層目から5層目への垂直部材です
- 5層目の梁は5層目の節点間を水平に接続する部材です
- 全ての層で柱と梁を完全に配置してください（欠落させない）
- 階高3.5mの場合、Y座標は0, 3.5, 7, 10.5, 14mに配置
- スパン6mの場合、X座標は0, 6, 12, 18, 24mに配置（5列）
- 4スパン = 5列の節点が必要です（スパン数+1）`;
        } else if (structureInfo.layers >= 4 && structureInfo.spans >= 4) {
            // 4層構造の例
            prompt += `

**4層ラーメン構造の例（4層4スパン）:**
節点配置: 各層に5本の柱（4スパン+1）、5層 = 25節点（4層目の梁用に5層目の節点が必要）
部材配置: 20本の柱 + 16本の梁 = 36部材
...
**4層構造の特別注意事項:**
- **重要**: 4層構造では5層分の節点（25節点）が必要です（4層目の梁を配置するため）
- **重要**: 4層目の柱は3層目から4層目への垂直部材です（5本）
- **重要**: 4層目の梁は4層目から5層目の節点間を水平に接続する部材です（4本）
- **重要**: 全ての層で柱と梁を完全に配置してください（欠落させない）
- **重要**: 階高3.5mの場合、Y座標は0, 3.5, 7, 10.5, 14mに配置（5層分）
- **重要**: スパン6mの場合、X座標は0, 6, 12, 18, 24mに配置（5列）
- **重要**: 4スパン = 5列の節点が必要です（スパン数+1）
- **重要**: 4層構造の部材数: 20本の柱 + 16本の梁 = 36部材

**4スパン構造の必須ルール:**
- 4スパン構造では必ず5列の節点を配置してください（X座標: 0, 6, 12, 18, 24m）
- 4スパン構造では必ず4本の梁を各層に配置してください
- 4スパン構造では絶対に3スパン（4列の節点）にしないでください
- スパン数と列数の関係: 4スパン = 5列の節点（スパン数+1）
- 各層の梁数 = スパン数（4本）`;
        } else {
            // 中小規模構造の例
            prompt += `
...
**基本構造の境界条件設定ルール:**
- 梁構造: 両端を固定支点（"x"）またはピン支点（"p"）に設定
- カンチレバー: 固定端を固定支点（"x"）、自由端を自由（"f"）に設定
- 連続梁: 中間支点をピン支点（"p"）またはローラー支点（"r"）に設定
- アーチ構造: 両端をピン支点（"p"）に設定
- 構造の種類に応じて適切な境界条件を判断してください`;
    }
...
- 支点の種類:
  ...
  - "r"（ローラー）: 一方向の変位のみ拘束
  - "f"（自由）: 変位と回転が自由
- 構造の安定性を確保するため、適切な境界条件を設定してください
