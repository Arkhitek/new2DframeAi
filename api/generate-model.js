...
- 5層目の柱：21→26,22→27,23→28,24→29,25→30
- 5層目の梁：26→27,27→28,28→29,29→30
...
- 4層目の柱：16→21,17→22,18→23,19→24,20→25
- 4層目の梁：21→22,22→23,23→24,24→25
...
**4層構造の特別注意事項:**
- 4層構造では5層分の節点（25節点）が必要
- 4層目の柱は3層目から4層目への垂直部材（5本）
- 4層目の梁は4層目から5層目の節点間を水平に接続（4本）
- 階高3.5mの場合、Y座標は0,3.5,7,10.5,14mに配置
- スパン6mの場合、X座標は0,6,12,18,24mに配置
- 4スパン=5列の節点が必要（スパン数+1）
- 4層構造の部材数: 20本の柱+16本の梁=36部材

**4スパン構造の必須ルール:**
- 4スパン構造では必ず5列の節点を配置（X座標:0,6,12,18,24m）
- 4スパン構造では必ず4本の梁を各層に配置
- 4スパン構造では絶対に3スパン（4列の節点）にしない
