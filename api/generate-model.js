...
- 下弦材は必ず全ての下部節点間を接続してください（欠落させない）`;
        ...
        if (structureInfo.layers >= 4 && structureInfo.spans >= 4) {
            // 大規模構造（4層4スパン以上）の例
            prompt += `
...

{
  "nodes": [
    ...
    {"x": 0, "y": 4, "s": "f"}, {"x": 6, "y": 4, "s": "f"}, {"x": 12, "y": 4, "s": "f"}, {"x": 18, "y": 4, "s": "f"}, {"x": 24, "y": 4, "s": "f"},
    {"x": 0, "y": 8, "s": "f"}, {"x": 6, "y": 8, "s": "f"}, {"x": 12, "y": 8, "s": "f"}, {"x": 18, "y": 8, "s": "f"}, {"x": 24, "y": 8, "s": "f"},
    {"x": 0, "y": 12, "s": "f"}, {"x": 6, "y": 12, "s": "f"}, {"x": 12, "y": 12, "s": "f"}, {"x": 18, "y": 12, "s": "f"}, {"x": 24, "y": 12, "s": "f"}
  ],
  "members": [
    // 柱（20本）
